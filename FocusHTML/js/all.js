...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Manual Focus ERP","1. Operações Básicas do Sistema","1.1. Cadastro de Figura Fiscal","1.2. Cadastro de Produtos","1.3. Alteração de Preços","1.4. Cargas de Produtos","1.5. Exportar Produtos para Balança","1.6. Cadastro Fornecedor","1.7. Financeiro","1.2.1. Dados do Produto","1.2.2. Dados Comerciais do Produto","1.3.1. Alterar Preço do Produto","1.3.2. Alterar Preço de Produto no Cadastro","1.6.1. Aba Cadastral","1.6.2. Aba Comercial","1.6.3. Aba Relacionamento","1.6.4. Aba Parâmetros","1.6.5. Consulta Fornecedor","1.7.1. Abertura Dia Financeiro","1.7.2. Consulta Dia Financeiro","1.7.3. Bancos e Conta","1.7.4. Centros de Custos","1.7.5. Autorização Detalhada de Títulos","1.7.3.1. Incluir Conta Banco"],
    DREX_NODE_LINKS: ["index.htm","operacoes_basicas_do_sistema.htm","cadastro_de_figura_fiscal.htm","cadastro_de_produtos.htm","alteracao_de_precos.htm","cargas_de_produtos.htm","exportar_produtos_para_balanca.htm","cadastro_fornecedor.htm","financeiro.htm","dados_do_produto.htm","dados_comerciais_do_produto.htm","alterar_preco_do_produto.htm","alterar_preco_de_produto_no_cadastro.htm","aba_cadastral.htm","aba_comercial.htm","aba_relacionamento.htm","aba_parametros.htm","consulta_fornecedor.htm","abertura_dia_financeiro.htm","consulta_dia_financeiro.htm","bancos_e_conta.htm","centros_de_custos.htm","autorizacao_detalhada_de_titulos.htm","incluir_conta_banco.htm"],
    DREX_NODE_CHILD_START: [1,2,9,9,11,13,13,13,18,23,23,23,23,23,23,23,23,23,23,23,23,24,24,24],
    DREX_NODE_CHILD_END: [2,9,9,11,13,13,13,18,23,23,23,23,23,23,23,23,23,23,23,23,24,24,24,24],
    DREX_MENU_TYPE: 1,
